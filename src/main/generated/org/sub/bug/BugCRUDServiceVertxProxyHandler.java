...
public class BugCRUDServiceVertxProxyHandler extends ProxyHandler {
  ...
  public BugCRUDServiceVertxProxyHandler(Vertx vertx, BugCRUDService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public BugCRUDServiceVertxProxyHandler(Vertx vertx, BugCRUDService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public BugCRUDServiceVertxProxyHandler(Vertx vertx, BugCRUDService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
